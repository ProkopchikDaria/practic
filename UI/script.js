    ...
    return {
        getPhotoPosts: function (skip , top , filterConfig){
            ...
            if (typeof skip === "number" && typeof top === "number" && filterConfig ) {
                ...
                if(filterConfig.hasOwnProperty('author'))
                {
                 ...
                 if( filterConfig.hasOwnProperty('createdFrom')&& filterConfig.createdFrom  instanceof Date&&
                     filterConfig.hasOwnProperty('createdTo')&& filterConfig.createdTo instanceof Date  ) {
                     res=res.filter(function (value) {
        ...
        validatePhotoPost: function (photoPost)  {
            if(typeof(photoPost.id)==='string' && typeof(photoPost.author)==='string'
                ...
                &&typeof(photoPost.photoLink)==='string' &&  photoPost.createdAt instanceof Date
...
console.log(fun.getPhotoPosts(0,10,filterByHashTag));
console.log("По дате  ");
